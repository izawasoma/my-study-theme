<!-- ギャラリー用のjQueryライブラリ -->
<?php wp_enqueue_style("fotorama", "https://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.css"); ?>
<?php wp_enqueue_script("fotorama", "https://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.js", ['jquery']); ?>
<?php get_header(); ?>
<?php if (have_posts()) : ?>
